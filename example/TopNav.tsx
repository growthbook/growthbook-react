...
import { WithRunExperimentProps, withRunExperiment } from '../dist/';

class TopNav extends React.Component<WithRunExperimentProps> {
  render() {
...
export default withRunExperiment(TopNav);